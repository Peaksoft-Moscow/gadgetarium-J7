package com.peaksoft.gadgetariumj7.config;
...
public class SwaggerConfig {
    ...
    private static final String API_TITLE = "Your API header";
    private static final String API_DESCRIPTION = "Description of your API";
    private static final String API_VERSION = "1.0";
    private static final String TOKEN_ACCESS_NAME = "Token Access";
    private static final String TOKEN_ACCESS_KEY = "token";
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder().title(API_TITLE)
                .description(API_DESCRIPTION).version(API_VERSION)
                .build();
    }
